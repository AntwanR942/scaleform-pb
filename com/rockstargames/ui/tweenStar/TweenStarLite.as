class com.rockstargames.ui.tweenStar.TweenStarLite
{
	...
	function updateAll()
	{
		...
		{
			if (this.vars.onUpdateArgs == undefined)
			{
				this.vars.onUpdateArgs = [];
			}

			this.vars.onUpdateArgs.unshift(_loc2_);

			this.vars.onUpdate.apply(this.vars.onUpdateScope,this.vars.onUpdateArgs);
		}

		if (_loc2_ == 1)
		{
			for (_loc3_ in this.props)
			{
